...
export const ROLE_COLLECTOR_BODY = [CARRY, MOVE, WORK]
export const ROLE_BUILDER_BODY = [CARRY, MOVE, WORK, HEAL]
export const ROLE_DEFENDER_BODY = [MOVE, ATTACK, RANGED_ATTACK, HEAL]
export const ROLE_ATTACKER_BODY = [MOVE, MOVE, MOVE, ATTACK]
export const ROLE_RANGER_BODY = [MOVE, RANGED_ATTACK]
export const ROLE_HEALER_BODY = [MOVE, HEAL, RANGED_ATTACK]